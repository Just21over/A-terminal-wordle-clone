...
Required Modules needed to run this

Colorama module - this is needed to colour the text. to download it type
pip install colorama 

Python 3.13- for some reason Colorama doesn’t work with any version of python 
above 3.13

If like any thing is wrong I will try to update it when i can.
